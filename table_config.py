# table_config.py — SQL Server version
...
TABLE_CONFIG = {
    ...
    "Stamperia": {
        ...
        "editable_cols": [
            "Temp_pesa", "Temp_misc", "Temp_press",
            "Temp_assist_press", "Flag",
        ],
        "update_sql": """
            UPDATE [Stamperia]
...
"Forno_cottura": {
    ...
    "Tornitura": {
        ...
        "editable_cols": [
            ...
            "Temp_rett",  "Temp_prof",  "Temp_resin",
            "Flag",
        ],
        "update_sql": """
            UPDATE [Tornitura]
    ...
    "Collaudo": {
        ...
        "editable_cols": [
            ...
            "Temp_velo", "Temp_marca",   "Temp_chius",
            "Flag",
        ],
        "update_sql": """
            UPDATE [Collaudo]
...
GROUP_TABLES = {
    "Group 1": ["Stamperia", "Forno_cottura", "Tornitura", "Collaudo"],
